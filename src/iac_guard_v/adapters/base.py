...
class AdapterReason(str, Enum):
    ...
    CONTAINER_RUNTIME_INTEGRITY_INCONCLUSIVE = "CONTAINER_RUNTIME_INTEGRITY_INCONCLUSIVE"
    CONTAINER_RUNTIME_CHANGED = "CONTAINER_RUNTIME_CHANGED"
    CONTAINER_RUNTIME_CONTEXT_CHANGED = "CONTAINER_RUNTIME_CONTEXT_CHANGED"
    SEVERITY_EVIDENCE_MISMATCH = "SEVERITY_EVIDENCE_MISMATCH"
    SCAN_PATH_MISMATCH = "SCAN_PATH_MISMATCH"
