...
- IaC-Guard-V implementation digest: `5101b3b9a66fea48a1d3b29f8915a6b6280a9a6cca2c37db12e7329d69da8b8e`
...
- Frozen baseline manifest: `6027ae079029e5907bb69c15392775edc75758256cc8ab5058358c0a2d9d4ff3`
- Frozen patch manifest: `c081e50b40657980666141dac524ab2062f5e5cb5ebd7a21b92cc8eef516577a`
- Frozen run manifest: `d9ef4318911bc70fba2c2c0286626978bf3376b0de95a2d22f63a3e6ff51aef8`
...
parser attempt. They are not production verification verdicts. Domain syntax failure
is `FAIL`; missing parser capability is `UNSUPPORTED`; internal or operational parser
failure is `ERROR`.

This file is generated from the canonical analysis values by
`research/compat/compare_legacy_hardened.py`; its deterministic regeneration is tested.
