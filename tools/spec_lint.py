...
CANDIDATE_ACCEPTANCE_OUTCOMES = ("SATISFIED", "VIOLATED", "INCONCLUSIVE")
SCANNER_ADDRESSABILITY_CLASSES = (
    "SCANNER_PRIMARY_ADDRESSABLE", "TARGET_RELEVANT_GRAPH_PARTICIPANT",
    "GOVERNED_NON_TARGET_SCANNER_UNADDRESSED", "CONSERVATIVE_SCANNER_ADDRESSABLE",
)
...
VALIDATED_SCREENING_READINESS = (
    "READY_FOR_VALIDATED_SCREENING", "NOT_READY_FOR_VALIDATED_SCREENING",
)
PROCESS_REASONS = (
...
ADAPTER_REASONS = (
    ...
    "CONTAINER_RUNTIME_INTEGRITY_INCONCLUSIVE", "CONTAINER_RUNTIME_CHANGED",
    "CONTAINER_RUNTIME_CONTEXT_CHANGED",
    "SEVERITY_EVIDENCE_MISMATCH", "SCAN_PATH_MISMATCH",
)
...
VALIDATION_REASONS = (
    "COMPLETED", "INVALID_CONFIGURATION", "NEEDS_INIT", "UNSUPPORTED_CONDITION",
    "PROCESS_ERROR", "TIMEOUT", "MALFORMED_OUTPUT", "DUPLICATE_JSON_KEY",
    "JSON_DEPTH_EXCEEDED", "OUTPUT_DIRECTORY_INTEGRITY_FAILED",
    "INPUT_CHANGED_DURING_VALIDATION", "RUNTIME_INTEGRITY_FAILED",
    "VERSION_OR_LOCK_DRIFT", "DIAGNOSTIC_CONTRADICTION", "EMPTY_SCOPE",
    "MISSING_SCHEMA", "CRD_SCHEMA_UNAVAILABLE", "SCHEMA_BUNDLE_CHANGED",
    "INCOMPLETE_COVERAGE", "ADVISORY_FINDINGS", "PLUGIN_INITIALIZATION_REQUIRED",
    "BASELINE_EVIDENCE_INVALID",
    "MATERIALIZED_VIEW_INTEGRITY_FAILED",
    "MODULE_SCOPE_UNRESOLVED", "AFFIRMATIVE_RESOURCE_COVERAGE_UNAVAILABLE",
...
def main() -> int:
    ...
    families = {
        ...
        "CandidateAcceptanceOutcome": CANDIDATE_ACCEPTANCE_OUTCOMES,
        "ScannerAddressabilityClass": SCANNER_ADDRESSABILITY_CLASSES,
        "DeltaClass": DELTA_CLASSES,
        "IdentityTier": IDENTITY_TIERS,
        "AgreementState": AGREEMENT_STATES,
        "MappingConfidence": MAPPING_CONFIDENCE,
        "ValidatedScreeningReadiness": VALIDATED_SCREENING_READINESS,
        ...
        "ArtifactCoverageKind": ARTIFACT_COVERAGE_KINDS,
        "ScanRole": SCAN_ROLES,
        ...
        "ValidationReason": VALIDATION_REASONS,
